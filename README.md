...
| `CF_AI_DEFAULT_MODEL`   | `@cf/google/gemma-4-26b-a4b-it` | Default Cloudflare AI model               |
...
- **Tiered AI router** — automatic cost optimization; small prompts use free Gemma 4 26B, larger ones escalate to Claude
